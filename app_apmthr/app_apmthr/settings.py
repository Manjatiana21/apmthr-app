"""
Django settings for app_apmthr project.
...
WSGI_APPLICATION = 'app_apmthr.wsgi.application'
...
LOGIN_URL = "authentification"          # où rediriger si non connecté
LOGIN_REDIRECT_URL = "home"  # où rediriger après connexion réussie
LOGOUT_REDIRECT_URL = "authentification" # où rediriger après déconnexion
